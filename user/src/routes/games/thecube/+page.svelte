	...
	<main>
		...
		<section class="flex flex-col" style="justify-content: center; gap: 20px;">
			<a class="flex flex-row" style="color: white; width: fit-content; align-items: center; gap: 5px;" href="/games">
				...
				<h1 style="color: white;">The Cube</h1>
			</a>

			<iframe style="height: calc(100vh - 220px); width: 100%; border-radius: 10px;" src="https://happy-heart-games.onrender.com/TheCube/index.html" title="Game" frameborder="0"></iframe>
		</section>
