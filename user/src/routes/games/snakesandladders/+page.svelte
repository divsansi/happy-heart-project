...
<SignedIn let:user>
	...
	<main>
		...
		<section class="flex flex-col" style="justify-content: center; gap: 20px;">
			...
			<iframe style="height: calc(100vh - 220px); width: 100%; border-radius: 10px;" src="https://happy-heart-games.onrender.com/SnakesAndLadders/index.html" title="Game" frameborder="0"></iframe>
		</section>
